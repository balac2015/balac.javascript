    ...
    <div class="block">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="15" class="nav-demos">
          <img src="@/assets/images/navbar_1.png" alt="Categorías de Nivel 1" @click="enlarge(846, $event)">
          ...
          <img src="@/assets/images/navbar_2.png" alt="Categorías de Nivel 2" @click="enlarge(846, $event)">
          ...
          <img src="@/assets/images/navbar_3.png" alt="Categorías de Nivel 3" @click="enlarge(846, $event)">
