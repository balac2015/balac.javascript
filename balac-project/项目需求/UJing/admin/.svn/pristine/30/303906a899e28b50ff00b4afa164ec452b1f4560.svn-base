 ...
 * @type {Schema}
 */
var OrderSumMonthFrancSchema = new Schema({
...
OrderSumMonthFrancSchema.plugin(CreateUpdatedAt)
OrderSumMonthFrancSchema.methods = {}

var OrderSumMonthFranc = mongoose.model('OrderSumMonthFranc', OrderSumMonthFrancSchema)
