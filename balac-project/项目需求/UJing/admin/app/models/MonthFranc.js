 ...
 * @type {Schema}
 */
var MonthFrancSchema = new Schema({
...
MonthFrancSchema.plugin(CreateUpdatedAt)
MonthFrancSchema.methods = {}

var MonthFranc = mongoose.model('MonthFranc', MonthFrancSchema)
