 ...
 * @type {Schema}
 */
var OrderSumDayFrancSchema = new Schema({
...
OrderSumDayFrancSchema.plugin(CreateUpdatedAt)
OrderSumDayFrancSchema.methods = {}

var OrderSumDayFranc = mongoose.model('OrderSumDayFranc', OrderSumDayFrancSchema)
